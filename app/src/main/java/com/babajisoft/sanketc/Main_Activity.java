...
/******************************************************************************************************/
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Intent i=getIntent();
		if(i!=null) {
			partno = i.getStringExtra("partno");
			srno = i.getStringExtra("srno");
			name = i.getStringExtra("name");
			booth = i.getStringExtra("booth");
			cardno = i.getStringExtra("cardno");
		}

		TextView txtpartno   = (TextView) findViewById(R.id.txtpartno);
		TextView txtFullname = (TextView)findViewById(R.id.txtname);
		TextView txtvoterno  = (TextView) findViewById(R.id.txtvoterno);
		TextView txtBooth    = (TextView) findViewById(R.id.txtBooth);
		TextView txtId        = (TextView)findViewById(R.id.txtId);
		layoutprint=(LinearLayout)findViewById(R.id.printimag);
		txtpartno.setText(partno);
		txtFullname.setText(name);
		txtvoterno.setText(srno);
		txtBooth.setText(booth);
		txtId.setText(cardno);
				// Get local Biluetooth adapter
...
/*****************************************************************************************************/	
	private void KeyListenerInit() {
		...
		if (null != SearchActivity.bitmapImage) {
			//SaveImage(SearchActivity.bitmapImage);
			//imageViewPicture.setImageBitmap(SearchActivity.bitmapImage);
		}
		...
		}else if(mService.getState() == BluetoothService.STATE_NONE){
			mService = new BluetoothService(this, mHandler);
		}else{
		...
		public void handleMessage(Message msg) {
			...
			case MESSAGE_STATE_CHANGE:
				...
				case BluetoothService.STATE_CONNECTED:
					...
					btnScanButton.setOnClickListener(new OnClickListener() {
						@Override
...
/****************************************************************************************************/
	...
	//	byte[] buffer = PrinterCommand.POS_Set_PrtInit();
		...
		Bitmap mBitmap = getViewBitmap(layoutprint);//((BitmapDrawable) imageViewPicture.getDrawable())
				//.getBitmap();
       SaveImage(mBitmap);
		int nMode = 0;
		int nPaperWidth = 384;
