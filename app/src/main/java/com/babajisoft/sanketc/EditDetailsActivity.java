  ...
  /*      i.putExtra("fullname", selectedperson.getFullName());
            ...
            case DATE_DIALOG_ID:
                _date = new DatePickerDialog(this, mDateSetListener, mYear, mMonth,
                     ...
                     */
                        ...
                        if ((mYear < year) && ((mMonth < monthOfYear) && (mYear == year))
    ...
    private DatePickerDialog.OnDateSetListener mDateSetListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear,
            ...
            Calendar userAge = new GregorianCalendar(mYear,mMonth,mDay);
            Calendar minAdultAge = new GregorianCalendar();
            minAdultAge.add(Calendar.YEAR, -18);
            if (minAdultAge.before(userAge)) {
                ToastHelper.showToast(getApplicationContext(),"Please select Valid Date",Toast.LENGTH_LONG);
               // SHOW_ERROR_MESSAGE;
            }else{
                updateDisplay();
            }
